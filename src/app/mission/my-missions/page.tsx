...
import { FaPlus, FaFilter, FaTimes, FaSort, FaClock, FaExclamationTriangle, FaArrowLeft } from "react-icons/fa";
...
export default function MyMissionsPage() {
  ...
  const fetchMissions = async () => {
    try {
      ...
      let url = "/api/missions/my-missions?";
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="relative mb-8 rounded-2xl bg-gradient-to-r from-indigo-600 to-blue-500 overflow-hidden">
        ...
        <div className="relative px-8 py-12 text-white">
          <h1 className="text-3xl font-bold mb-4">Mes missions</h1>
          <p className="text-white/80 max-w-2xl">
            Missions que vous avez créées et que vous gérez.
          </p>
        </div>
      </div>
